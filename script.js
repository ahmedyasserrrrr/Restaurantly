...
function setLanguage(language) {
    ...
    document.querySelector('.language-toggle-ar').textContent = (language === 'ar') ? 'English' : 'AR';
    document.querySelector('.language-toggle-en').textContent = (language === 'ar') ? 'EN' : 'English';
}